  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <KPICard title="Pedidos Cancelados" value={String(daily.reduce((s, d) => s + d.cancelled, 0))} icon={<X className="w-5 h-5" />} variant="destructive" loading={loading} refreshing={syncing} />
      </div>
