    ...
    <div className="space-y-6">
        ...
        <div className="hidden md:flex flex-1 justify-center">
          <div className="w-full max-w-xs">
            <KPICard
              ...
              className="text-center [&_div]:justify-center [&_span]:justify-center [&_p]:text-center [&>div]:py-1.5 bg-gradient-to-r from-primary/5 to-transparent shadow-[0_0_12px_hsl(var(--primary)/0.12)] border-primary/20 [&_p]:text-primary [&_span]:font-semibold [&_span]:text-primary/80"
            />
          </div>
        </div>
      ...
      <div className="md:hidden">
        <KPICard
          ...
          variant="default"
          className="bg-gradient-to-r from-primary/5 to-transparent shadow-[0_0_12px_hsl(var(--primary)/0.12)] border-primary/20 [&_p]:text-primary [&_span]:font-semibold [&_span]:text-primary/80"
          loading={effectiveLoading}
          refreshing={effectiveSyncing}
          subtitle={periodLabel}
        />
