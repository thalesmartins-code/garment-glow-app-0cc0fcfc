...
> = {
  ...
  magalu:   { baseSeed: 256,  orders: [10, 30],  ticket: [100, 350], inventoryCount: 15, currency: "BRL" },
...
const PRODUCT_TITLES: Record<string, string[]> = {
  ...
  magalu: [
    "Smart TV LG 55\" 4K", "Geladeira Brastemp Frost Free", "Máquina Lavar Electrolux 12kg",
    "Ar Condicionado Split 12000 BTU", "Notebook Lenovo IdeaPad", "iPhone 15 128GB",
    "Aspirador Robô Xiaomi", "Cafeteira Nespresso Vertuo", "Fritadeira Air Fryer Mondial 5L",
    "Micro-ondas Panasonic 32L", "Processador Philips Walita", "Ventilador Arno Turbo",
    "Fogão Consul 4 Bocas", "Batedeira Planetária KitchenAid", "Purificador Água Electrolux",
    "Forno Elétrico Philco 44L", "Liquidificador Oster 3 Velocidades", "Ferro a Vapor Philips",
    "Cama Box Casal Ortobom", "Sofá Retrátil 3 Lugares",
  ],
  netshoes: [
